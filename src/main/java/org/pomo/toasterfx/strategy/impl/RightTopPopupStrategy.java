 ...
 * <br/>
 *
 * <p>创建时间：2020-09-27 15:37:17</p>
 * <p>更新时间：2020-09-27 15:37:17</p>
 *
 * @author Mr.Po
 * @version 1.0
 */
public class RightTopPopupStrategy extends AbstractVerticalPopupStrategy {

    public RightTopPopupStrategy(@NonNull MultiToastFactory multiToastFactory, @NonNull Duration duration) {
    ...
    protected double getAnchorY(@NonNull Rectangle2D visualBounds,
                                @NonNull Toaster toaster, @NonNull ToastParameter parameter) {
        return visualBounds.getMinY() + parameter.getFixY();
    }
    ...
    protected double getNewAnchorY(@NonNull Rectangle2D visualBounds,
        ...
        return visualBounds.getMinY() + parameter.getFixY()
                + (toasters.stream().skip(index).mapToDouble(Toaster::getHeight).sum() - toaster.getHeight());
    }
}
